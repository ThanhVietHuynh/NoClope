...
<body>
    ...
    ?>
    <p>
        Bonjour {{ $remember_token }} ! Si vous recevez cet email, c'est que votre ami(e) vous a invité a bien vouloir l'aider afin
        d'arrêter de fumer ! Cliquez sur le lien pour donner ou non votre accord !
    </p>
